...
scripts/{qa-verify.sh,qa-ci.sh,report-to-junit.sh,memory-sync.sh,provenance.sh,
         ...
         toolstream.sh}                          runtime + CI-export + hook scripts (see "Bundled scripts" below)
...
qa-kit/                                          the 2nd plugin (process shell): .claude-plugin/plugin.json (dependencies:[qa-e2e-pilot]),
                                                 ...
                                                 spec-snapshot,verify-plan,runconfig-merge,data-baseline,check-fixtures,detect-seed,auto-seed,build-qakit-adapter,validate-qakit-adapters,run-qakit-ci}.sh, templates/, agents/qa-kit.md, README.md;
