...
**Still deferred:** sub-plan **B** (the behavioral/interaction family 9 — `detecting-interaction-ux`) and sub-plan **C** (the generative critic layer 3, the accuracy-harness UI/UX taxonomy fixture, and the ≥95% recall / ≥90% precision measured gate, §11) have **not** landed. The ≥95% recall gate is therefore **not yet measured** — it lands with effort C's fixture.
