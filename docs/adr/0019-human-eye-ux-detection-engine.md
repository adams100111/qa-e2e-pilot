...
**Still deferred:** sub-plan **C** (the generative critic layer 3, the accuracy-harness UI/UX taxonomy fixture, and the ≥95% recall / ≥90% precision measured gate, §11) has **not** landed. The ≥95% recall gate is therefore **still not measured** — it lands with effort C's fixture.
